...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        .setName('lottery')
        .setDescription('Start a lottery pool that other people can join. Random winner is draw, winning the whole pool.')
        ...
        .addNumberOption((option) => option
            ...
            .setDescription('Amount of seconds to wait before starting the lottery draw.')
            .setRequired(true)
            .setMinValue(30)
            .setMaxValue(120)
        )
